...
# **PROYECTO**
**A tokenized AMLCFT Ramp to get a Colaterized Colombia Stablecoin (COPX) coletarized with GHO. This Dashboard will allows user get real services (eg. restaurants) with automated payments from their Vault or withdraw GHO to use in Crypto Ecosystem.**
