...
# **PROJECT**
**A tokenized AMLCFT Ramp to get a Colombia Stablecoin (COPX) Colaterized with GHO. This Dashboard will allows user get real services (eg. restaurants) with automated debit payments from their Vault or withdraw GHO to use in Crypto Ecosystem..**
